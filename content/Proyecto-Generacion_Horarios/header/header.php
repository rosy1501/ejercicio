        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item" href="content/select_php.php">Manejo de Select</a>
              <a class="dropdown-item" href="content/ejercicios_js/Ejercicio_tabla.HTML">Ejercicio tabla</a>
